...
namespace YoutubeAPI
{
    public static class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            {
                BinaryFolder = Path.Combine(Path.GetDirectoryName(Assembly.GetEntryAssembly().Location), "FFmpeg", "bin", 
                Environment.OSVersion.Platform switch
                {
                    PlatformID.Win32S or PlatformID.Win32Windows or PlatformID.Win32NT or PlatformID.WinCE => "windows",
                    PlatformID.Unix or PlatformID.MacOSX => "unix",
                    _ => throw new PlatformNotSupportedException($"Platform {Environment.OSVersion.Platform} is not supported by FFmpeg")
                }
